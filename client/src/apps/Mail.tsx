...
const emails: Email[] = [
  ...
  { id: 3, from: 'GitHub', avatar: '🐙', subject: '[vibeos] Pull request #42 merged', preview: 'Merge pull request #42 from feature/calculator...', time: 'Yesterday', starred: true, folder: 'inbox', date: 'Yesterday', body: 'Merge pull request #42 from feature/calculator\n\nFix calculator overflow bug\n\nCommit: abc1234\nAuthor: vibeos-dev\n\nPull request successfully merged!' },
